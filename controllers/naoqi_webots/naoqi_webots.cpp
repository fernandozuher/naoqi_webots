...
#include "naoqi_webots.hpp"

int main(int argc, char *argv[])
{
    naoqi_webots obj {argc, argv};
    return 0;
}

//////////////////////////////////////////////////////////////////////////////

naoqi_webots::naoqi_webots(int argc, char **argv) :
                   argc {argc}, argv {argv}, use_cameras {true} 
{
    try {
        try {
            std::cout << "\n--------------------" << __FILE__ << "--------------------";
            std::cout << "\n(constructor) Initializing controller naoqi_webots:";
...
void naoqi_webots::__check_command_line_arguments()
{
    if (argc != 2 && argc != 3)
...
void naoqi_webots::__init_webots_stuff()
{
    // Initialize Webots
...
void naoqi_webots::__singletons()
{
...
void naoqi_webots::__print_usage()
{
